...
<head>
	<meta charset="utf-8">
	<title>Prijava ili registracija</title>
...
<body class="form-v8">
	<div class="page-content">
		<div class="form-v8-content">
			<div class="form-left">
				<img src="https://thetransformation.company/wp-content/uploads/2018/01/KeepReadingLearning.jpg" alt="form">
			</div>
			<div class="form-right">
				<div class="tab">
					<div class="tab-inner">
						<button class="tablinks" onclick="openCity(event, 'sign-up')" id="defaultOpen">Registracija</button>
					</div>
					<div class="tab-inner">
						<button class="tablinks" onclick="openCity(event, 'sign-in')">Prijava</button>
					</div>
				</div>
					...
					<div class="tabcontent" id="sign-up">
						...
						<div class="form-row">
							<label class="form-row-inner">
								...
								<span class="label">Potvrda lozinke</span>
								<span class="border"></span>
							</label>
						</div>
				...
				<form class="form-detail" action="#" method="post">
					<div class="tabcontent" id="sign-in">
						...
						<div class="form-row-last">
							<input type="submit" name="register" class="register" value="Prijavi se">
						</div>
					</div>
				</form>
			</div>
